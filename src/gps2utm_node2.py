...
y_offset=0
def cb_pos(data):
    global x0_loc,y0_loc,x0,y0,x_offset,y_offset
    ...
    if x0_loc==-1000 and y0_loc==-1000:
        ...
        lm_off_loc_pub_msg.linear.x=x_loc_now-x_offset
        lm_off_loc_pub_msg.linear.y=y_loc_now-y_offset
        lm_off_loc_pub_msg.angular.z=th
        lm_off_loc_pub.publish(lm_off_loc_pub_msg)

        lm_off_pub_msg=Twist()
        lm_off_pub_msg.linear.x=x_loc_now-x_offset+x0
        lm_off_pub_msg.linear.y=y_loc_now-y_offset+y0
        lm_off_pub_msg.angular.z=th
        lm_off_pub.publish(lm_off_pub_msg)

        lm_off_odom_msg=Odometry()
        lm_off_odom_msg.pose.pose.position.x=x_loc_now-x_offset+x0
        lm_off_odom_msg.pose.pose.position.y=y_loc_now-y_offset+y0
...
def cb_offset(data):
    ...
    x_offset=data.linear.x
    y_offset=data.linear.y
