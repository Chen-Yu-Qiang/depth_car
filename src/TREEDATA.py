...
try:
    ...
    print("[TREEDATA.py] Use Original MAP. A total of "+str(len(TREE_DATA))+" tree")
    X_MIN=2767650.7422344387
    X_MAX=2767730.222274709
    Y_MIN=-352905.1814219437
    Y_MAX=-352847.6228367216
    R_MIN=0.1
    R_MAX=0.8
